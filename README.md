...
[![NPM](https://img.shields.io/npm/v/react-native-meditor.svg)](https://www.npmjs.com/package/react-native-meditor)

------

> 此项目基于 https://github.com/wxik/react-native-rich-editor

> A fully functional Rich Text Editor for both Android and iOS (macOS and windows)?

```
yarn add react-native-meditor
or
npm i react-native-meditor
```
